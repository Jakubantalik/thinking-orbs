...
export function Header({ theme: _theme, onToggleTheme: _onToggleTheme }: { theme: Theme; onToggleTheme: () => void }) {
  return (
    <header className="relative w-full h-[218px] text-center flex flex-col items-center justify-end pb-[53px] max-sm:h-auto max-sm:min-h-[180px] max-sm:pt-[60px] max-sm:pb-8">
      ...
      <div className="relative -mt-[150px] -mb-2 cursor-pointer group" aria-hidden="true">
        <img
